...
<head>
<title>Queen Emma Lily (Crinum augustum)</title>
<meta name="robots" content="index,follow" />
<link rel="canonical" href="https://www.to-hawaii.com/flowers/queenemmalily.php" />
...
<div class="breadcrumbs" align="left">
 ...
 <span itemprop="position" content="3"></span>
  &raquo;  Queen Emma Lily </li>
</ol></div>

            <h1 class="title">Queen Emma Lily Photos</h1>
            <div class="clear"></div>
            <div class="new-custom">
              <div class="midpanel_row">
                <div class="gallery-container">
                  <div class="feature"> <img  alt="Queen Emma Lily" src="images/queenemmalily/queen_emma_lily.jpg" />
                    <div class="caption"></div>
                  </div>
                  <div class="gallery">
                    <ul class="thumb-list">
			<li class="active"><a rel="images/queenemmalily/queen_emma_lily.jpg"  class="galImg"><img src="images/queenemmalily/queen_emma_lily.jpg"  class="thumb"  alt="Queen Emma Lily"/></a></li>
                    </ul>
                  </div>
                </div>
                <div style="clear:both"></div>
<h2 class="small">Queen Emma Lily Overview</h2>
<p>This flower is associated with Hawaiian royalty. Queen Emma was the wife of King Kamehameha IV. The Queen's Hospital in Honolulu was established by Queen Emma. She also had an interest in gardening and had beautiful gardens on her Kauai estate, which is now the site of Allerton Garden. This plant was one of Queen Emma's favorites. It is native to Mauritius and the Seychelles and prefers moist conditions and shade.</p>
