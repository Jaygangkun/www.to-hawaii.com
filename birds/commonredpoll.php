...
<link rel="canonical" href="https://www.to-hawaii.com/birds/commonredpoll.php" />
...
<div class="layout">
 ...
 <span itemprop="position" content="3"></span>
  &raquo;  Common Redpoll</li>
</ol></div>

            <h1 class="title">Common Redpoll Photos</h1>
          <div class="clear"></div>
          <div class="new-custom">
            <div class="midpanel_row">
              <div class="gallery-container">
                <div class="feature"> <img alt="Common Redpoll"  src="images/commonredpoll/common_redpoll.jpg" />
                  <div class="caption"></div>
                </div>
                <div class="gallery">
                  <ul class="thumb-list">
                    <li class="active"><a rel="images/commonredpoll/common_redpoll.jpg"  class="galImg"><img src="images/commonredpoll/common_redpoll.jpg"  class="thumb" alt="Common Redpoll"  /></a></li>
                  </ul>
                </div>
              </div>
              <div style="clear:both"></div>
              <h2 class="small">Common Redpoll Overview</h2>
              <p>The common redpoll belongs to the family of finches. Its habitat is in shrubs and thickets. Adult makes have a bright red crown, a black chin, black-brown wings and tail, and a red or pink cheek and breast. Its flanks have lines of dark streaks. Adult females look similar to males, but are darker and streakier. Their bodies show little or no red, except on their crown.</p>
