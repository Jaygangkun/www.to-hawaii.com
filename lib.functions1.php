...
session_start();
require_once "lib.functions_map_functions1.php";
	...
	$('.booknowbutton').click(function(){
		...
		if (href.indexOf("arrivalDate") >= 0) {
			...
			if ($('#arriveDate').val() && $('#departDate').val()) {
				href = href+'&arrivalDate='+$('#arriveDate').val()+'&departureDate='+$('#departDate').val()+'&adultsCount=2';
				//arriveDate
				//departDate
				location.href = href;
			}
		...
		return false;
	//http://www.tkqlhce.com/click-4042034-12588772?URL=http://www.vrbo.com/1239830?unitId=1790767&cid=l_ha3pd-affiliate-6_&arrivalDate=08/25/2019&departureDate=08/27/2019&adultsCount=1
//http://www.tkqlhce.com/click-4042034-12588772?URL=http://www.vrbo.com/786450?unitId=1334388&cid=l_ha3pd-affiliate-6_&arrivalDate=08/18/2019&departureDate=08/21/2019&adultsCount=1
//http://www.tkqlhce.com/click-4042034-12588772?URL=http://www.vrbo.com/786450?unitId=1334388&cid=l_ha3pd-affiliate-6_&arrivalDate=08/08/2019&departureDate=15/08/2019&adultsCount=2
	});
