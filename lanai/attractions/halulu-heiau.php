...
<head>
<title>Halulu Heiau, Lanai</title>
<meta name="description" content="Halulu Heiau on Lanai is one of the most impressive archaeological sites on the island." />
<meta name="keywords" content="halulu heiau, lanai, hawaii, photos, reviews, map, weather, location, temple" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="robots" content="index,follow" />
<link rel="canonical" href="https://www.to-hawaii.com/lanai/attractions/halulu-heiau.php" />
...
<div class="breadcrumbs" align="left">
 ...
 &raquo; Halulu Heiau</li>
</ol>

</div><h1 class="title"><span itemprop="name">Halulu Heiau</span></h1>
            <div class="clear"></div>
            <div class="new-custom">
              <div class="midpanel_row">
                <div class="gallery-container">
                  <div class="feature"> <img  itemprop="image" alt="Halulu Heiau"  src="../../../lanai/attractions/images/haluluheiau/halulu_heiau.jpg" />
                    <div class="caption"></div>
                  </div>
                  <div class="gallery">
                    <ul class="thumb-list">
                      <li class="active"><a   rel="../../../lanai/attractions/images/haluluheiau/halulu_heiau.jpg" class="galImg"><img src="../../../lanai/attractions/images/haluluheiau/halulu_heiau.jpg"  class="thumb" alt="Halulu Heiau"   /></a></li>
                      <li><a  rel="../../../lanai/attractions/images/haluluheiau/lanai_heiau.jpg"  class="galImg"><img src="../../../lanai/attractions/images/haluluheiau/lanai_heiau.jpg"  class="thumb" alt="Heiau on Lanai"  /></a></li>
                    </ul>
                  </div>
                </div>
                <div style="clear:both"></div>
                <h2 class="small">Halulu Heiau, Lanai</h2>
                <p>Halulu Heiau is one of the most impressive archaeological sites on Lanai. Take a nature walk amidst ancient stone walls and bask in the pristine beauty of a well-preserved Hawaiian place of worship. The heiau makes a stunning presence with its stark color and intricate construction, set against the peaceful backdrop of the ancient seaside village of Kaunolu on Lanai's south shore. Halulu Heiau was one of the last few  to be erected, which is why it is still mostly intact. It was in use up to circa 1819.</p>
                <p>The heiau once served as a place of refuge, built by King Kamehameha to challenge those who broke the law. In order to be forgiven, outlaws had to make it to the temple before getting caught. The location for the heiau was strategically chosen, and it was almost impossible to reach it, making it difficult for lawbreakers to attain forgiveness. Even today, you'll have to drive up around 3 miles (4.8 km) of rough, rocky road to reach it. During the dry season, Halulu Heiau can only be accessed with a four-wheel drive vehicle. If it's wet, you can't drive here at all but will have to walk. </p>
                    <? include ("../../theme/text.html") ?>
                <p>Left of Halulu is <a href="../attractions/kahekilisleap.php">Kahekili&rsquo;s Leap</a>, also known as Warriors Leap. From this natural platform, Kamehameha's elite warriors would prove themselves by leaping 80 feet (24 m) into the ocean below. Visitors to the heiau should keep in mind that it is disrespectful to walk on the rock walls or enter a heiau anywhere in Hawaii, including Halulu Heiau. It is also not allowed to move or take any of the stones. </p>
                
                <h2 class="big">Halulu Heiau Overview</h2>
                <ul type="disc" class="mylist">
                  <li>Ancient Hawaiian temple site</li>
                  <li>Located in Kaunolu on Lanai's southwestern shore</li></ul> <div style="clear:both"></div>
                <br />
...
<li id="menu2"><a href="javascript: void(0)" onclick="product('2')"><span>Map</span></a></li>
                ...
                <div id="tab_container">
                  <div id="contenttab2" style="display:none;">
                    ...
                    <script>
function initialize() {
var myLatLng = new google.maps.LatLng(20.734597,-156.965266);
var mapOptions = {
    zoom: 15,
    center: myLatLng,
  ...
  var beachMarker = new google.maps.Marker({
      ...
      icon: image
                    ...
                    <br />
                    <strong>Driving Directions:</strong> From Lanai City, take Highway 440 west toward Kaumalapau Harbor. Past the airport turnoff, turn left onto Kaupili Road, which is an unmarked dirt road. After about 2.5 miles (4 km), you&rsquo;ll see a yellow water pipe on the right. Make a right turn here. This road goes downhill and leads to Kaunolu and Halulu Heiau after about 3 miles (4.8 km). </div>
...
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
                  ...
                  <p>
                    <?php $id="259"; include "../../reviews/main.php"; ?>
                  </p>
               </div>
              </div>
            </div>
