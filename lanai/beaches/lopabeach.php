...
<head>
<title>Lopa Beach, Lanai</title>
<meta name="description" content="Lopa Beach on Lanai with photos, map, reviews and beach info." />
<meta name="keywords" content="lopa beach, lanai, photos, reviews, map, weather, location, fishpond, loko lopa, swimming" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="robots" content="index,follow" />
<link rel="canonical" href="https://www.to-hawaii.com/lanai/beaches/lopabeach.php" />
...
</div><h1 class="title"><span itemprop="name">Lopa Beach</span></h1>
            <div class="clear"></div>
            <div class="new-custom">
              <div class="midpanel_row">
                <div class="gallery-container">
                  <div class="feature"> <img  itemprop="image" alt="Lopa Beach"  src="../../../lanai/beaches/images/lopabeach/lopa_beach.jpg" />
                    <div class="caption"></div>
                  </div>
                  <div class="gallery">
                    <ul class="thumb-list">
                      <li class="active"><a   rel="../../../lanai/beaches/images/lopabeach/lopa_beach.jpg"   class="galImg"><img src="../../../lanai/beaches/images/lopabeach/lopa_beach.jpg"  class="thumb" alt="Lopa Beach" /></a></li>
                      <li><a  rel="../../../lanai/beaches/images/lopabeach/lopa_beach_2.jpg"   class="galImg"><img src="../../../lanai/beaches/images/lopabeach/lopa_beach_2.jpg"  class="thumb" alt="Remote Lanai beach" /></a></li>
                    </ul>
                  </div>
                </div>
                <div style="clear:both"></div>
                <h2 class="small">Lopa Beach, Lanai</h2>
                <p>Lopa Beach, located on Lanai&rsquo;s east coast, is a long white sand beach. It begins on the south side of Kikoa Point and ends past an old fishpond, which is the most outstanding feature on this beach. The fishpond is also called Loko Lopa and has been designated as a bird sanctuary. </p>
                <p>The offshore ocean bottom at Lopa Beach is shallow and rocky. It&rsquo;s safe to swim here when the waters are calm. Lopa Beach is a secluded beach that&rsquo;s mainly frequented by local fishermen. You can reach it by taking one of the four-wheel-drive trails branching off the Keomuku Road.</p>
                
                <h2 class="big">Lopa Beach Overview</h2>
                <ul type="disc" class="mylist">
                  <li>Long white sand beach on Lanai's east coast</li>
                  <li>Rocky ocean bottom</li>
                  <li>Swimming possible when the waters are calm</li>
                  <li>Ancient fishpond Loko Lopa is located here</li></ul> <div style="clear:both"></div>
                <br />
...
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
                  ...
                  <p>
                    <?php $id="252"; include "../../reviews/main.php"; ?>
                  </p>
                </div>
              </div>
            </div>
