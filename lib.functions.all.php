...
require_once "lib.functions_map_functions.all.php";
...
.accommodations .accommodation::after {
    content: ',';
    margin-left: 3px;
}
    ...
    <form name="SortRes" id="SortRes" method="post">
        ...
        <div style="padding: 5px 10px 5px 10px;">
                ...
                <div class="box-content box-li">
                    ...
                    <div class="hit-content" style="width: 60%;padding: 0px;">
                        ...
                        <div style="float: left;width: 100%;padding: 18px 18px 0px 18px;background: white;">
                            ...
                            <p class="description"><?php echo tokenTruncate($data['description'],145);?>
			...
			<?php
				...
				if (   in_array($data['city'], $oahu_cities) ||  in_array($data['postalCode'], $oahu_zipcodes)  || strpos($data['region'], 'Oahu') !== false ) {
			?>	
					
                            <br><b>Registration Number:</b> <?php echo $data['registration_number']; ?>
			<?php
				}
			?>		
