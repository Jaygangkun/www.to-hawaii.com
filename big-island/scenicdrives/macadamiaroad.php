...
<head>
<title>Macadamia Road, Big Island</title>
...
<meta name="keywords" content="macadamia road, hawaii, big island, macadamia nut farm" />
...
<div class="breadcrumbs" align="left">
 ...
 &raquo; Macadamia Road </li>
</ol>

</div>

<h1 class="title"><span itemprop="name">Macadamia Road</span></h1>
                    <div class="clear"></div>
                    <div class="new-custom">
                      <div class="midpanel_row">
                        <div class="gallery-container">
                          <div class="feature"> <img  itemprop="image" alt="Macadamia Road" src="../../../big-island/scenicdrives/images/macadamiard/macadamia_road.jpg" />
                            <div class="caption"></div>
                          </div>
                          <div class="gallery">
                            <ul class="thumb-list">
                              <li class="active"><a  rel="../../../big-island/scenicdrives/images/macadamiard/macadamia_road.jpg" class="galImg"><img src="../../../big-island/scenicdrives/images/macadamiard/macadamia_road.jpg"  class="thumb"  alt="Macadamia Road"  /></a></li>
                            </ul>
                          </div>
                        </div>
                        <div style="clear:both"></div>
                        <h2 class="small">Macadamia Road, Big Island</h2>
                        <p>About 7 miles (11 km) south of Hilo is Macadamia Road, which leads to the <a href="../attractions/maunaloamacadamianutcompany.php">Mauna Loa</a> macadamia nut farm and visitor center. It's a fun 3-mile (5 km) drive through macadamia nut orchards with fun fact signs about macadamia nuts along the way. Once you arrive at the visitor center, you can see Mauna Loa's macadamia nut and chocolate processing plant and visit their gift shop. </p>
                    <? include ("../../theme/text-desktop-only.html") ?>
                        <h2 class="big">Macadamia Road Overview</h2>
                        <ul type="disc" class="mylist">
                          <li>3-mile drive through macadamia nut orchards</li>
                          <li>Fun educational plaques about macadamias along the way</li>
                        </ul><div style="clear:both"></div>
<br />
<h3 class="big">Vacation Rentals near Macadamia Road</h3>
<?php
   ...
   directionsService.route(request, function(response, status) {
      if (status == google.maps.DirectionsStatus.OK) {
         directionsDisplay.setDirections(response);
                            ...
                            <div itemprop="address" itemscope itemtype="http://schema.org/PostalAddress"> <span itemprop="streetAddress">Macadamia Road</span>, <span itemprop="addressRegion">Big Island</span> </div>
                            <br />
...
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
                          ...
                          <p>
                            <?php $id="986"; include "../../reviews/main.php"; ?>
                          </p>
                        </div>
                      </div>
                    </div>
